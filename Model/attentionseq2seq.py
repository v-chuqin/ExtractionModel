...
if __name__ == "__main__":
	...
	# input_dim=embedding_size, input_length=maxlen, 
	seq2seqmodel = AttentionSeq2Seq(output_dim=rnn_size,output_length=maxlenh,hidden_dim=rnn_size,depth=3,name='seq2seq',input_dim=embedding_size, input_length=maxlen)
	...
	for iteration in range(50):
		...
		file = h5py.File('data/%s.hdf5'%FN,'w')
